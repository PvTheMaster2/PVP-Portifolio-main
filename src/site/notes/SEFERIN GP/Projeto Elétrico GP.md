...
<div class="project-gallery reveal">
  <img src="/assets/imagens/casa-gp/capa_thumb.jpg" alt="Fachada do projeto Casa GP" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/casa-gp/planta_eletrica_thumb.jpg" alt="Planta elétrica Casa GP" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/casa-gp/unifilar_thumb.jpg" alt="Diagrama unifilar e quadro de cargas" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/casa-gp/rooftop_thumb.jpg" alt="Detalhamento elétrico do rooftop" class="gallery-thumb" loading="lazy">
</div>
...
[📄 **Ver Planta Elétrica Geral**](/assets/pdfs/casa-gp_eletrica.pdf){:target="_blank" .reveal}  
[📄 **Ver Quadro de Cargas + Diagrama Unifilar**](/assets/pdfs/casa-gp_unifilar.pdf){:target="_blank" .reveal}
