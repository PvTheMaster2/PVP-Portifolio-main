...
<div class="project-gallery reveal">
  <img src="/assets/imagens/projeto-gt/capa_thumb.jpg" alt="Fachada do projeto GT" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/projeto-gt/planta_situacao_thumb.jpg" alt="Planta de situação e entrada elétrica" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/projeto-gt/unifilar_thumb.jpg" alt="Diagrama unifilar" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/projeto-gt/quadros_thumb.jpg" alt="Quadro de cargas detalhado" class="gallery-thumb" loading="lazy">
</div>
...
[📄 **Ver Planta Elétrica Geral**](/assets/pdfs/projeto-gt_eletrica.pdf){:target="_blank" .reveal}  
[📄 **Ver Diagrama Unifilar e Quadro de Cargas**](/assets/pdfs/projeto-gt_unifilar.pdf){:target="_blank" .reveal}
