...
class ViewModeByFrontmatterPlugin extends obsidian.Plugin {
  ...
  onload() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const readViewModeFromFrontmatterAndToggle = leaf =>
        __awaiter(this, void 0, void 0, function* () {
          let view =
            leaf.view instanceof obsidian.MarkdownView ? leaf.view : null;
          if (null === view) {
          ...
          for (const folderMode of this.settings.folders) {
            if (folderMode.folder !== '' && folderMode.viewMode) {
              ...
              if (folder instanceof obsidian.TFolder) {
                ...
                console.warn(
                  `ForceViewMode: Folder ${folderMode.folder} does not exist or is not a folder.`
                );
              }
            }
          }
          ...
          const defaultEditingModeIsLivePreview =
            this.app.vault.config.livePreview === undefined
              ? true
...
function resetOpenedNotes(app) {
  ...
  app.workspace.iterateAllLeaves(leaf => {
    ...
    openedFiles.push(
      (_b = (_a = leaf.view) === null || _a === void 0 ? void 0 : _a.file) ===
        null || _b === void 0
        ? void 0
        : _b.basename
    );
    ...
    this.plugin.settings.folders.forEach((folderMode, index) => {
      ...
      const s = new obsidian.Setting(this.containerEl)
        ...
        .addDropdown(cb => {
          ...
          cb.setValue(folderMode.viewMode || 'default').onChange(value =>
            __awaiter(this, void 0, void 0, function* () {
    ...
    this.plugin.settings.files.forEach((file, index) => {
      ...
      const s = new obsidian.Setting(this.containerEl)
        ...
        .addDropdown(cb => {
          ...
          cb.setValue(file.viewMode || 'default').onChange(value =>
            __awaiter(this, void 0, void 0, function* () {
