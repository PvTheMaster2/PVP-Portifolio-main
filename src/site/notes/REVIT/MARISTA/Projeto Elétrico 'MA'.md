...
<div class="project-gallery reveal">
  <img src="/assets/imagens/sala-aula/capa_thumb.jpg" alt="Vista 3D das eletrocalhas da sala de aula reformada" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/sala-aula/cd_thumb.jpg" alt="Detalhamento dos quadros e perfilados elétricos" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/sala-aula/situacao_thumb.jpg" alt="Planta da nova situação elétrica" class="gallery-thumb" loading="lazy">
</div>
...
[📄 **Ver Projeto Sala de Aula (PDF)**](/assets/pdfs/sala_aula_2023.pdf){:target="_blank" .reveal}
