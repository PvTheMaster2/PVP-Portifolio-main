...
<div class="project-gallery reveal">
  <img src="/assets/imagens/projeto-cd/capa_thumb.jpg" alt="Vista da fachada - projeto CD" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/projeto-cd/unifilar_thumb.jpg" alt="Diagrama unifilar" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/projeto-cd/quadro_cargas_thumb.jpg" alt="Quadro de cargas detalhado" class="gallery-thumb" loading="lazy">
  <img src="/assets/imagens/projeto-cd/planta_situacao_thumb.jpg" alt="Planta de situação da entrada elétrica" class="gallery-thumb" loading="lazy">
</div>
...
[📄 **Ver Planta Elétrica Geral**](/assets/pdfs/projeto-cd_eletrica.pdf){:target="_blank" .reveal}  
[📄 **Ver Diagrama Unifilar e Quadro de Cargas**](/assets/pdfs/projeto-cd_unifilar.pdf){:target="_blank" .reveal}
